    ...
    <header className="z-10 flex justify-between items-center px-40 py-6 text-white bg-transparent relative">
      ...
      {btn && (
        <div className="flex items-center space-x-4">
          ...
          {/* Sign In Button */}
          <button
            className="bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-3 py-1 rounded-md"
      ...
      {signIn && (
        <Link className="text-gray-800 text-xl font-semibold" to={"/login"}>
          Sign In
        </Link>
      )}
      ...
      {user && (
        <div
          className="profile-background h-10 w-10 rounded-sm cursor-pointer"
